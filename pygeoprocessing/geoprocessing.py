...
def new_raster_from_base_uri(
    ...
    geoprocessing_cython.new_raster_from_base_uri(
...
def new_raster_from_base(
    ...
    return geoprocessing_cython.new_raster_from_base(
...
def reclassify_by_dictionary(
    ...
    geoprocessing_cython.reclassify_by_dictionary(
...
def calculate_slope(
    ...
    geoprocessing_cython._cython_calculate_slope(dem_small_uri, slope_uri)
...
def distance_transform_edt(
    ...
    geoprocessing_cython.distance_transform_edt(
